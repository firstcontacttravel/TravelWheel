@component('layouts.app', ['title' => 'Protocol Plans - TravelWheel'])
    <main id="main" style="padding-top: 60px;">
        <section class="shadow-sm py-4 pt-5">
            <div class="container">
                <div class="row pt-3">
                ...
                <div class="row pb-5">
                    <div class="col-md-7 pb-3">
                        <div class="bg-light p-3 shadow-sm">
                            <p style="color:rgba(13,156,83,1);"><b>All the benefits of using our Airport Protocol Services In All Nigeria Local Airports</b></p>
                            ...
                            <h6>NB: <b style="color:red;">A Protocol Boarding Pass will be generated after a Successful transaction. It expires after Departure / Arrival date.</b></h6>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        @endphp
                        <div class="row">
                            <div class="col-sm-10 protocol-hide" id="departure">
                                <div class="card p-3 mb-3 shadow-sm">
                                    <h5 class="text-center">Departure Plan</h5>
                                    <hr>
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="text-muted"><i class="fa fa-check text-success"></i> <b>Pre Check-in Process.</b></li>
                            ...
                            <div class="col-sm-10 protocol-hide" id="arrival">
                                <div class="card p-3 mb-3 shadow-sm">
                                    <h5 class="text-center">Arrival Plan</h5>
                                    <hr>
                                    <ul class="list-unstyled">
                                        <li class="text-muted"><i class="fa fa-check text-success"></i> <b>Meet and Greet.</b></li>
                                        <li class="text-muted"><i class="fa fa-check text-success"></i> <b>Exclusive baggage handling.</b></li>
