@component('layouts.app', ['title' => 'Travel Insurance - TravelWheel'])
            ...
            <div class="col-sm-7">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0" style="color:rgba(13,156,83,1);">Get Quote — Allianz</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-5">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0" style="color:rgba(13,156,83,1);">Leadway Insurance</h5>
                    </div>
                    <div class="card-body text-center p-4">
                        <img src="{{ asset('assets/image/leadway.png') }}" class="img-fluid mb-3" style="max-height:80px;" alt="Leadway">
                        <p class="text-muted">Access Leadway's wide range of travel insurance products.</p>
                        <a href="{{ route('air.insuranceLeadway') }}" class="btn btn-success">Get Leadway Quote</a>
                    </div>
                </div>
            </div>
        </div>
