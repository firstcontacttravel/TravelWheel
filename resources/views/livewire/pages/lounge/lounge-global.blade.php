<div>
    ...
    <section class="vw-hero">
        <div class="vw-hero__inner">
            ...
            <form class="vw-card" action="{{ route('air.lounge.global.search') }}" method="POST" id="loungeGlobalForm">
                @csrf
                <div class="vw-card__head">
                    <div>
                        <span class="vw-kicker">Worldwide lounge search</span>
                        <h2>Find a lounge at any airport</h2>
                    </div>
                </div>
    ...
    <div class="lounge-grid p-3">
        ...
        <div class="lounge-panel">
            ...
            <div class="lounge-steps">
                <span class="lounge-step lounge-step-active"><x-ph-icon name="map-pin" /> Enter airport code</span>
                <span class="lounge-step"><x-ph-icon name="tag" /> Choose lounge</span>
                <span class="lounge-step"><x-ph-icon name="credit-card" /> Book with LoungePair</span>
            </div>
            <p class="lounge-copy">
                Results are pulled live from LoungePair and cover airports worldwide, in addition to our own local lounges.
            </p>
            <div class="lounge-note">Looking for a lounge in Abuja, Lagos, or Kano booked directly with us? <a href="{{ route('air.lounge') }}">Search our local lounges instead</a>.</div>
        </div>
    </div>
</div>
