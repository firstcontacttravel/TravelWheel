                ...
                <div class="row">
                  <div class="col-12 col-lg-9">
                    <div class="form-group">
                      ...
                      <input type="text" id="autocomplete1" class="form-control" name="address1" required autocomplete="off" placeholder="Your Address" oninput="updateParagraph()" onfocus="initAutocomplete1()"/>
                    </div>
                  </div>
                  <div class="col-12 col-lg-3">
                    <div class="form-group">
                      <label>Postal Code<sup>*</sup></label>
                      <input type="text" id="postalcode1" class="form-control" required name="postalcode1" oninput="updateParagraph()"/>
                    </div>
                  </div>
                </div>
                <div class="row">
              ...
              <div class="shipping-form">
                <div class="row">
                  <div class="col-12 col-lg-9">
                    <div class="form-group">
                      <label>Address<sup>*</sup></label>
                      <input type="text" id="autocomplete2" class="form-control" name="address2" required placeholder="Street Address" oninput="updateParagraph()" onfocus="initAutocomplete2()"/>
                    </div>
                  </div>
                  <div class="col-12 col-lg-3">
                    <div class="form-group">
                      <label>Zip Code<sup>*</sup></label>
                      <input type="text" id="postalcode2" class="form-control" name="postalcode2" required placeholder="Postal Code" oninput="updateParagraph()"/>
                    </div>
                  </div>
            ...
            <fieldset>
              ...
              <div class="shipping-form dropoff-block">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item"><a class="nav-link active" href="#no-drop" aria-controls="no-drop" role="tab" data-bs-toggle="tab">No, I'll drop it off</a></li>
                  <li class="or-text">--or--</li>
                  <li class="nav-item"><a class="nav-link" href="#yes-drop" aria-controls="yes-drop" role="tab" data-bs-toggle="tab">Yes, pick up my shipment</a></li>
                </ul>
