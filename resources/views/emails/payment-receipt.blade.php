    ...
    <tr>
        <td style="padding:26px 30px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:13px;">
                ...
                <tr><td style="padding:9px 0;border-bottom:1px solid #e2e8f0;color:#64748b;">Payment Date</td><td align="right" style="padding:9px 0;border-bottom:1px solid #e2e8f0;font-weight:700;">{{ $booking->payment_verified_at ? $booking->payment_verified_at->timezone('Africa/Lagos')->format('d M Y, H:i') : '-' }}</td></tr>
