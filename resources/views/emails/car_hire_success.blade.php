...
<head>
    ...
    <title>Car Hire Booking Confirmed</title>
    <style>
...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <p>Your car hire has been successfully booked</p>
    ...
    <div class="body">
        ...
        <p class="intro">
            Great news — your car hire booking is confirmed and payment has been received.
