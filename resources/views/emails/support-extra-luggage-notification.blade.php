...
  <title>New Extra Luggage Request - Payment Received</title>
</head>
...
              <h2 style="color:#ffffff; font-size:20px; margin:0;">New Extra Luggage Request - Payment Confirmed</h2>
            </td>
          </tr>
...
                A client has successfully made a payment for an Extra Luggage support request. 
...
                </tr>
                                <tr>
                  <td style="padding:8px; border-bottom:1px solid #eee;"><strong>Selected Airline:</strong></td>
                  <td style="padding:8px; border-bottom:1px solid #eee;">{{ $airline }}</td>
                </tr>
                <tr>
                  <td style="padding:8px; border-bottom:1px solid #eee;"><strong>Passport Data Page File:</strong></td>
                  <td style="padding:8px; border-bottom:1px solid #eee;">{{ $data_page }}</td>
                </tr>
                <tr>
                  <td style="padding:8px; border-bottom:1px solid #eee;"><strong>Ticket File:</strong></td>
